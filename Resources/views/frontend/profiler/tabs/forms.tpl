...
<div class="tree-details{if !$show} hidden{/if}" {if $data.id}id="{$data.id}-details"{/if}>
    ...
    <div id="{$data.id}-default_data">
        <table>
            ...
            <tr>
                ...
                {*<td>{$data.default_data.seek('norm')|dump}</td>*}
            </tr>
            <tr>
                <th class="font-normal" scope="row">View Format</th>
                <td>
                    {if $data.default_data.view}
                        {*{$data.default_data.seek('view')|dump}*}
                    {else}
                    <em class="font-normal text-muted">same as normalized format</em>
                    {/if}
                </td>
    ...
    <div id="{$data.id}-submitted_data">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    {if $data.submitted_data.view}
                        {*{data.submitted_data.seek('view')|dump}*}
                    {else}
                        <em class="font-normal text-muted">same as normalized format</em>
                    {/if}
                </td>
            ...
            <tr>
                <th class="font-normal" scope="row">Normalized Format</th>
                {*<td>{data.submitted_data.seek('norm')|dump}</td>*}
            </tr>
            <tr>
                <th class="font-normal" scope="row">Model Format</th>
                <td>
                    {if $data.submitted_data.model}
                        {*{$data.submitted_data.seek('model')|dump}*}
                    {else}
                        <em class="font-normal text-muted">same as normalized format</em>
                    {/if}
                </td>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    {else}
                        {*{$data.resolved_options.seek(option)|dump}*}
                    {/if}
                </td>
            </tr>
            {/foreach}
